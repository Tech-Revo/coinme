...
<head>
  ...
  <title>Crypo</title>
  <link rel="icon" href="{{url('assets/img/fav.png')}}" type="image/x-icon">
...
<body id="dark">
            ...
            <div class="dropdown-menu">
              ...
              <div class="dropdown-body">
                <ul class="profile-nav">
                  ...
                  <li class="nav-item">
                    <a href="/login" class="nav-link red">
  ...
  <script src="{{url('assets/js/amcharts-core.min.js')}}"></script>
  <script src="{{url('assets/js/amcharts.min.js')}}"></script>
